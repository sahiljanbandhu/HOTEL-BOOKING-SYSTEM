...
<body>
  ...
  <div class="form-group">
    ...
    <div class="col-1-4 col-1-4-sm">
      <div class="controls">
        Arrive:<input type="date" id="arrive" class="floatLabel" name="arrive" value="<?php echo date('Y-m-d'); ?>">
<!--         <label for="arrive" class="label-date"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Arrive</label>
 -->      </div>      
    </div>
    <div class="col-1-4 col-1-4-sm">
      <div class="controls">
        Depart:<input type="date" id="depart" class="floatLabel" name="depart" value="<?php echo date('Y-m-d'); ?>" />
...
<!--                 <label for="fruit"><i class="fa fa-male"></i>&nbsp;&nbsp;People</label>
 -->        
        Person:<select class="floatLabel">
...
<!--         <label for="fruit"><i class="fa fa-male"></i>&nbsp;&nbsp;People</label>
 -->      </div>      
    ...
    <div class="controls">
      <i class="fa fa-sort"></i>
      Room:<select class="floatLabel">
        <option value="blank"></option>
        <option value="deluxe">With Bathroom</option>
...
<!--       <label for="fruit">Room</label>
 -->     </div>     
      ...
      <div class="grid">
        ...
        <br>
        <div class="controls">
         Comments: <textarea name="comments" class="floatLabel" id="comments"></textarea>
