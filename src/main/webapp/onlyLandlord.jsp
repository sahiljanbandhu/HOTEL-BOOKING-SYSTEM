	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="./img/pexels-pixabay-271618.jpg"
					alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100"
					src="./img/pexels-pixabay-271619 - Copy.jpg" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="./img/pexels-pixabay-271624.jpg"
					alt="Third slide">
			</div>
		</div>
	...
	<div class="card-deck">
		<div class="card">
			...
			<div class="card-footer">
				<a class="btn btn-primary" href="bookNow.html" role="button">BOOK
					NOW</a>
			</div>
		</div>
		<div class="card">
