			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="CustomerGetAll.jsp">Show All Customer</a> 
						 <a class="dropdown-item" href="CustomerDelete.jsp">Delete
							...
							check Out</a><a class="dropdown-item" href="newhome.html">logout
						</a>
					</div></li>
