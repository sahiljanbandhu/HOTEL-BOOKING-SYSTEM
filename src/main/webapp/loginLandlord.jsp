...
<link href="https://fonts.googleapis.com/css?family=Kaushan+Script"
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css?family=Kaushan+Script|Wendy+One"
	rel="stylesheet">
				...
				<div class="row h-50 justify-content-center">
					<div class="col-md-8 main-con p-3 justify-content-center">
						<form class="form-horizontal" action="#" method="post">
							...
							<br>
							<p>
								<font color=white><font size=3px;>No Username and
										Password? Register Here For Free! 
							</p>
						...
						<p class="text-center t">Brought To You</p>
					</div>
				</div>
			</div>
	</section>
